        ...
        {activeTab === "about" && (
          <div className="p-4 sm:p-6 lg:p-8 bg-linear-to-br from-slate-50 to-blue-50/30 border border-slate-200 rounded-3xl shadow-sm max-w-7xl mx-auto">
            <div className="text-center mb-12 lg:mb-16">
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold bg-linear-to-r from-slate-800 to-blue-800 bg-clip-text text-transparent mb-4 tracking-tight">
                Department of Computer Science
              </h1>
              <div className="w-20 sm:w-24 lg:w-32 h-1 bg-linear-to-r from-sky-300 to-sky-600 mx-auto rounded-full mb-4"></div>
            </div>
            ...
            <section className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
              <div className="group relative bg-linear-to-br from-white to-blue-50 rounded-3xl p-8 shadow-lg border border-blue-100 hover:shadow-xl transition-all duration-500">
              ...
              <div className="group relative bg-linear-to-br from-white to-purple-50 rounded-3xl p-8 shadow-lg border border-purple-100 hover:shadow-xl transition-all duration-500">
                <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-linear-to-r from-sky-500 to-sky-400 rounded-2xl p-6 text-white">
                    <h4 className="font-bold text-lg mb-3">Strategic Focus Areas</h4>

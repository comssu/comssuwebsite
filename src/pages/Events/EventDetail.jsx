...
import { Calendar, Clock, MapPin, Users, ArrowLeft, Star, Award, Target, BookOpen, GraduationCap, CheckCircle, Clock as ClockIcon, Lightbulb } from "lucide-react";
        ...
        <div className="flex-1 flex items-center justify-center px-4">
          <div className="text-center max-w-md">
            <div className="relative">
              <div className="absolute -inset-4 bg-gradient-to-r from-sky-400 to-blue-500 rounded-2xl blur-lg opacity-20"></div>
              <div className="relative bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-white/20 shadow-2xl">
                <div className="w-20 h-20 bg-gradient-to-br from-sky-400 to-blue-500 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
                  <Award className="text-white w-8 h-8" />
                </div>
                <h2 className="text-2xl font-bold bg-gradient-to-r from-sky-600 to-blue-600 bg-clip-text text-transparent mb-3">
                  Event Not Found
                </h2>
                ...
                <Link 
                  to="/events" 
                  className="inline-flex items-center gap-3 bg-gradient-to-r from-sky-500 to-blue-500 hover:from-sky-600 hover:to-blue-600 text-white font-semibold px-6 py-3 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                >
      ...
      <main className="flex-1">
        <div className="pt-24"> 
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
            <div className="relative">
              <div className="absolute -inset-4 bg-gradient-to-r from-sky-400/20 via-blue-400/10 to-cyan-400/20 rounded-3xl blur-xl"></div>
              ...
              <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
                ...
                <div className="relative h-96 overflow-hidden"> 
                  ...
                  <div className="absolute bottom-2 right-6">
                    {eventStatus && (
                      <div className={`bg-gradient-to-r ${eventStatus.color} text-white px-4 py-2 rounded-2xl shadow-lg border border-white/20 flex items-center gap-2`}>
                  ...
                  <div className="xl:col-span-3">
                    <div className="mb-8">
                      ...
                      <div className="prose prose-lg max-w-none">
                        <p className="text-gray-700 leading-relaxed text-lg mb-6 bg-gradient-to-r from-sky-50 to-blue-50 p-6 rounded-2xl border border-sky-100">
                          {event.description}
                        </p>
                      </div>
                    </div>
                    ...
                    {eventStatus?.status === 'upcoming' && event.keyTakeaways && event.whatToExpect && (
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                        ...
                        <div className="bg-gradient-to-br from-white to-amber-50 rounded-2xl p-6 border border-amber-100 shadow-lg hover:shadow-xl transition-all duration-300">
                          <div className="w-12 h-12 bg-gradient-to-br from-amber-400 to-orange-500 rounded-2xl flex items-center justify-center mb-4 shadow-lg">
                        ...
                        <div className="bg-gradient-to-br from-white to-blue-50 rounded-2xl p-6 border border-blue-100 shadow-lg hover:shadow-xl transition-all duration-300">
                          <div className="w-12 h-12 bg-gradient-to-br from-blue-400 to-sky-500 rounded-2xl flex items-center justify-center mb-4 shadow-lg">
                    ...
                    {eventStatus?.status === 'past' && (
                      <div className="bg-gradient-to-br from-blue-50 to-sky-50 rounded-2xl p-6 border border-blue-200 mb-8">
                    ...
                    <div className="bg-gradient-to-r from-sky-500/5 to-blue-500/5 rounded-2xl p-8 border border-sky-200/50">
